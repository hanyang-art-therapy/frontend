export const ART_WORKS_CONTACT = [
  {
    artsNo: 1,
    artistName: '강송이',
    artName: '나를 향해 가는길',
    caption: 'Acylic on canvas 100×80cm',
    description:
      '나와 세상을 잇는 감정의 흐름을 담아보았습니다. 수직으로 흐르는 초록빛 선들은 내가 속한 관계와 환경을, 중심의 분홍색 원은 내면 깊숙이 자리한 감정과 존재를표현하고자 했습니다. 때로는 단절된 듯 보이지만, 그 안 에서 자연스럽게 연결을 이루어 가는 과정처럼, 이 그림이 나 자신 과마주하고 감정을 들여다보는 따뜻한 쉼이 되길 바랍니다.',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-1.jpg',
  },
  {
    artsNo: 2,
    artistName: '구교희',
    caption: 'Acylic on canvas 73×91cm',
    artName: '흔적',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-2.jpg',
  },
  {
    artsNo: 3,
    artistName: '김도경',
    artName: '무제',
    caption: 'Gouache, Permanent Marker on canvas 50×70cm',
    description:
      '정의할 수 없는 인간관계의 미묘한 경계를 마음의 지도라는 이름으로 표현했습니다. 타인을 통해 결국 자신을 탐구하게 되는 이 여정에서 당신은 나의 마음 어디에 있나요?',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-3.jpg',
  },
  {
    artsNo: 4,
    artistName: '김도형',
    artName: '내일의 희망을 꿈꾸며',
    caption: 'Acylic on canvas 76.2×50.8cm   ',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-4.jpg',
  },
  {
    artsNo: 5,
    artistName: '김보영',
    artName: '나와 나',
    caption: '분채, 순지 91×65cm',
    description:
      '아이야, 어떤 모습도 괜찮아. 우리 같이 놀자. 소곤소곤 귓가에 들려주는 목소리가 좋아 난 아이야! 어린 시절 그때처럼 나랑 같이 놀자.♡',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-5.jpg',
  },
  {
    artsNo: 6,
    artistName: '김이슬',
    artName: '인사이드 미',
    caption: 'Acylic on canvas 91.0×116.8cm  ',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-6.jpg',
  },
  {
    artsNo: 7,
    artistName: '김지은',
    artName: 'Amor fati',
    caption: 'Acylic on canvas 91×65cm   ',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-7.jpg',
  },
  {
    artsNo: 8,
    artistName: '김희경',
    artName: '언젠가 우린 다시 만나',
    caption: 'Acylic on canvas 116.7×91cm',
    description:
      '켜켜이 쌓이는 삶의 자국들을 견디고 버티고 바라보기를 반복하며 언젠가는 만나질 나를 기다리다. ',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-8.jpg',
  },
  {
    artsNo: 9,
    artistName: '남선미',
    artName: '비추다',
    caption: 'Acylic on canvas 117×80cm',
    description:
      '하늘빛을 담고 고스란히 담고 싶었지만, 내 마음속 바다엔 잦은 바람과 파도가 넘실거리네. 잔잔한 호수가 아니기에, 내 모습 그대로 보여줄 수가 없어서 그대 혹여나 내 마음을 오해 말기를...',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-9.jpg',
  },
  {
    artsNo: 10,
    artistName: '류민아',
    artName: '조금 느려도 괜찮아',
    caption: 'Acylic on canvas 72.7×116.8cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-10.jpg',
  },
  {
    artsNo: 11,
    artistName: '마수민',
    artName: '~기운',
    caption: 'Acylic on canvas 91×73cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-11.jpg',
  },
  {
    artsNo: 12,
    artistName: '문지윤',
    artName: 'Mobius',
    caption: 'Acylic on canvas 72.7×91cm',
    description:
  ...
  },
  {
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-14.jpg',
  },
  {
    artsNo: 15,
    artistName: '박진호',
    artName: 'To. JinHo',
    caption: '조화 Acylic on canvas 72.7×90.9cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-15.jpg',
  },
  {
    artsNo: 16,
    artistName: '백은희',
    artName: 'amass',
    caption: 'Acylic on canvas 65×91cm, 65×91cm',
    description:
    ...
    cohort: '30기',
    uploadedAt: '2024-05-01T13:00:00',
    src: '/images/arts/art-2025-16.jpg',
  },
  {
    artsNo: 17,
    artistName: '성인경',
    artName: '순환(cycle)',
    caption: 'Acylic on canvas 50×50cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-17.jpg',
  },
  {
    artsNo: 18,
    artistName: '소명희',
    artName: '타인의 아이',
    caption: 'Acylic on canvas 91×116.8cm',
    description:
      '자신의 의지와는 상관없이 세상에 나온 아이가 누군가의 보호를 필요로 하고 있다. 위험요소가 가득한 세상이지만 사랑을 듬뿍 담은 양육자의 손길로 안전하고 풍요로운 세상을 만나게 해주고 싶다. ',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-18.jpg',
  },
  {
    artsNo: 19,
    artistName: '유봉미',
    artName: '비계(飛階)',
    caption: 'Acylic on canvas 91.0×91.0cm',
    description:
      '지금의 나는 그날의 나로 경험되고 그날의 나는 지금의 나로 안다. 이제서야 내가 지금의 나를 보고 이후에 나를 지금 여기서 만난다.',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-19.jpg',
  },
  {
    artsNo: 20,
    artistName: '윤희정',
    artName: '“숨, 결” 그 흔적과 회복',
    caption: '자연물 Acylic on canvas 91×117cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-20.jpg',
  },
  {
    artsNo: 21,
    artistName: '조자영',
    artName: '여름숲',
    caption: 'Acylic on canvas 41x54cm',
    description:
      '노을 빛 하늘, 장작 타는 소리, 싱싱한 숲 냄새, 맑고 따뜻한 밤.. 쉴 곳',
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-21.jpg',
  },
  {
    artsNo: 22,
    artistName: '조혜미',
    artName: '흩어진 연결-Bloom',
    caption: 'Acylic on canvas 91×116.8cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-22.jpg',
  },
  {
    artsNo: 23,
    artistName: '최지혜',
    artName: '일탈',
    caption: 'Acylic on canvas 117×91cm',
    description:
    ...
    uploadedAt: '2024-05-01T13:00:00',
    cohort: '30기',
    src: '/images/arts/art-2025-23.jpg',
  },
];
