    ...
    <section className='w-full h-[400px] flex justify-center relative banner-bg'>
      ...
      <div className='w-full max-w-[1260px] h-full flex flex-col justify-center items-center text-shadow-style relative'>
        <div className='xl:pl-0 pl-[20px] flex flex-col absolute top-[90px] left-0'>
          <p className='flex gap-[10px] items-end'>
            <span className='text-[18px] sm:text-[32px]'>한양대학교 ERICA</span>
            <span className='text-[14px] sm:text-[24px]'>융합산업대학원</span>
          </p>
          <h2 className='flex flex-col'>
            <span className='text-[32px] sm:text-[52px] font-[700]'>미술치료학과</span>
            <span className='text-[18px] sm:text-[32px]'>DEPARTMENT OF ART THERAPY</span>
          </h2>
        </div>
        <p className='xl:px-0 px-[20px] text-[14px] lg:text-[18px] sm:text-right leading-[24px] lg:leading-[32px] absolute bottom-[40px] right-0'>
