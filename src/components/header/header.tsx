...
export default function Header() {
  return (
    <header className='w-full h-[40px] pl-[20px] xl:pl-0 flex justify-center mx-auto bg-white sticky top-0 z-99'>
      <div className='w-full xl:w-[1080px] h-full flex items-center justify-between title-b-14'>
